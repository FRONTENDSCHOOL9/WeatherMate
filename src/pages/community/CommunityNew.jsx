    ...
    <div className="px-5 box-border">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex gap-2 float-right">
          <Button type="button" onClick={() => navigate('/community')} className="p-1 box-border bg-indigo-200 text-indigo-600 rounded-lg">취소</Button>
          <Submit className="p-1 box-border bg-indigo-200 text-indigo-600 rounded-lg">완료</Submit>
        </div>
